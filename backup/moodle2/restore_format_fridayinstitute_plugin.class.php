...
/**
 * Specialised restore for format_fridayinstitute
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_format_fridayinstitute_plugin extends restore_format_plugin {
    ...
    public function after_restore_course() {
        ...
        $backupinfo = $this->step->get_task()->get_info();
        if ($backupinfo->original_course_format !== 'fridayinstitute' || !isset($data['tags']['numsections'])) {
