@format @format_fridayinstitute
Feature: Sections can be edited and deleted in fridayinstitute format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete fridayinstitute
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | fridayinstitute | 0             | 5           |
  ...
  @javascript
  Scenario: Inline edit section name in fridayinstitute format
  ...
  Scenario: Deleting the last section in fridayinstitute format
  ...
  Scenario: Deleting the middle section in fridayinstitute format
